...
async def batch_link(_, message):
    ...
    max_batch_size = PREMIUM_LIMIT if user_id in user or user_id in OWNER_ID or await is_user_verified(user_id) else FREEMIUM_LIMIT
    ...
    join_button = InlineKeyboardButton("Join Channel", url="https://t.me/Mr_Mahiji")
    keyboard = InlineKeyboardMarkup([[join_button]])
    pin_msg = await app.send_message(
        user_id,
        f"Batch process started ⚡\nProcessing: 0/{cl}\n\n**Powered by MAHI Botz**",
