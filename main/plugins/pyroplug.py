        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[MAHI®](https://t.me/MR_MAHIJI)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\nby **[MAHI™](https://t.me/mr_mahiji)**__" if msg.caption else " by **[MAHI®](https://t.me/MR_MAHIJI)**__"
                await send_video_with_chat_id(client, sender, path, caption, duration, hi, wi, thumb_path, upm)
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[MAHI©](https://t.me/MR_MAHIJI)**__" if msg.caption else "__Unrestricted by **[MAHI®](https://t.me/MR_MAHIJI)**__"
                ...
                caption = f"{msg.caption}" if msg.caption else " by **[MAHI®](https://t.me/mr_mahiji)**__"
                await send_document_with_chat_id(client, sender, path, caption, thumb_path, upm)
            os.remove(file)
            await upm.delete()
            return None
